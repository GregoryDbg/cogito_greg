...
plate_tectonics = Quizz.create!(name:"Plate Tectonics", subject: "BIOLOGY", teacher: teacher2, photo_url:"http://res.cloudinary.com/dcsrdzgza/image/upload/v1496145657/cogito/tectonique.jpg")
geometry = Quizz.create!(name:"Geometry", subject: "MATHS", teacher: teacher2, photo_url: "http://res.cloudinary.com/dcsrdzgza/image/upload/v1496071900/cogito/maths_bpcjhj.jpg")
